Feature: Create volume and add to projects
  ...
  Scenario: Create project and volume, assign volume to project
    Given "user507" as the persona
    When I set "username" to "user507"
    ...
    And we should have the following user allocation source snapshots
      ...
      | user507             | user507           | 0.000        | 0.000     |
    When we get the projects via the API
    ...
    """
    When we get the volumes via the API
    Then the API response code is 200
    And the API response contains
    """
    []
    ...
    When we create a project called "My First Project" via the API
...
#    When we get the project volumes via the API
#    Then the API response code is 200
#    And the API response contains
#    """
#    [
